 ...
 *
 *
 *         La clase 'Piezas' corresponde a una superclase de la que heredarán
 *         sus atributos y el método 'movimiento' aquellas subclases que
 *         representan cada una de las figuras del ajedrez.
 */
...
public class Piezas {
	...
	// Constructor que inicia las coordenadas del tablero, el color de la pieza y el
	// nombre
