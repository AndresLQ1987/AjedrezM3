...
public class Rey extends Piezas {
	...
	/**
	 * Constructor de clase Rey que le pasa a la clase padre la poscion, el color y
	 * el nombre.
	 * 
	...
	/**
	 * Metodo que devuelve una matriz de boleanos cuyos boleanos indican los
	 * posibles movimientos dependiendo de la posicion de la pieza.
	 * 
	 * @param x     : indica la posicion x dentro del tablero donde se encuentra la
	 *              pieza
	 * @param y     : indica la posicion y dentro del tablero donde se encuentra la
	 *              pieza
	 * @param color : indica el color de la pieza (para rey no afecta a su
	 *              movimiento)
