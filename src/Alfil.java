...
/*
 * L'alfil: Quan es pinta per pantalla mostra una A i segons el seu color serà
 * AB o AN. Els possibles moviments d'un alfil: Pot moure's en tots els sentits
 * de la diagonal que ocupa.
 */
...
public class Alfil extends Piezas {
	...
	/**
	 * Es un metodo que devuelve una matriz de boleanos. Cada for hace los
	 * movimientos
	 * 
